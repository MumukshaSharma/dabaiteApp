...
class DeluxeThaliPage extends StatefulWidget {
  const DeluxeThaliPage({super.key});

  @override
  State<DeluxeThaliPage> createState() => _DeluxeThaliPageState();
}

class _DeluxeThaliPageState extends State<DeluxeThaliPage> {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            _buildMealCard(
                title: 'Deluxe Thali - Trial (3 Days)',
                oldPrice: '540',
                newPrice: '390',
